...
export function DarazForm({ initialData = {}, onSave, onCancel }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        <Label htmlFor="darazStoreName" className="text-neutral-300">Store Name <span className="text-red-500">*</span></Label>
        <Input
          id="darazStoreName"
          value={storeName}
      ...
      <div>
        <Label htmlFor="darazSellerId" className="text-neutral-300">Seller ID <span className="text-red-500">*</span></Label>
        <Input
          id="darazSellerId"
          value={sellerId}
